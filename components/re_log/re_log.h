/* 
 *  EN: Output debug messages to STDOUT with the ability to disable. Modified version of esp_log.h
 *  RU: Вывод отладочных сообщений в STDOUT с возможностью отлючения. Измененный вариант esp_log.h
 *  -----------------------------------------------------------------------------------------------------------------------
...
#define rlogc_v(tag, log_enabled, format, ...) if (log_enabled) _rlog_printf(RLOG_EXT_FORMAT(V, format), tag, ##__VA_ARGS__)
#define rloga_v(format, ...) _rlog_printf(RLOG_EXT_FORMAT(V, format), RLOG_DEFAULT_APP_TAG, ##__VA_ARGS__)
#else
#define rlog_v(tag, format, ...)
#define rlogc_v(tag, log_enabled, format, ...)
...
#define rlogc_d(tag, log_enabled, format, ...) if (log_enabled) _rlog_printf(RLOG_EXT_FORMAT(D, format), tag, ##__VA_ARGS__)
#define rloga_d(format, ...) _rlog_printf(RLOG_EXT_FORMAT(D, format), RLOG_DEFAULT_APP_TAG, ##__VA_ARGS__)
#else
#define rlog_d(tag, format, ...)
#define rlogc_d(tag, log_enabled, format, ...)
...
#define rlogc_i(tag, log_enabled, format, ...) if (log_enabled) _rlog_printf(RLOG_EXT_FORMAT(I, format), tag, ##__VA_ARGS__)
#define rloga_i(format, ...) _rlog_printf(RLOG_STD_FORMAT(I, format), RLOG_DEFAULT_APP_TAG, ##__VA_ARGS__)
#else
#define rlog_i(tag, format, ...)
#define rlogc_i(tag, log_enabled, format, ...)
...
#define rlogc_w(tag, log_enabled, format, ...) if (log_enabled) _rlog_printf(RLOG_EXT_FORMAT(W, format), tag, ##__VA_ARGS__)
#define rloga_w(format, ...) _rlog_printf(RLOG_EXT_FORMAT(W, format), RLOG_DEFAULT_APP_TAG, ##__VA_ARGS__)
#else
#define rlog_w(tag, format, ...)
#define rlogc_w(tag, log_enabled, format, ...)
...
#define rlogc_e(tag, log_enabled, format, ...) if (log_enabled) _rlog_printf(RLOG_EXT_FORMAT(E, format), tag, ##__VA_ARGS__)
#define rloga_e(format, ...) _rlog_printf(RLOG_EXT_FORMAT(E, format), RLOG_DEFAULT_APP_TAG, ##__VA_ARGS__)
#else
#define rlog_e(tag, format, ...)
#define rlogc_e(tag, log_enabled, format, ...)
